...
export class TransaksiService {
  ...
  getTransfer(
    ...
    return this.http.post(this.baseUrl + `transaksiNasabah/transfer?Nomor%20Rekening%20Asal=${norekAsal}&Nomor%20Rekening%20Tujuan=${norekTujuan}&Nominal=${nominal}`,
      {
        responseType: 'json',
      }
    );
  ...
  getBayartelepon(noRekening: number, noTelepon: number): Observable<any> {
    return this.http.post(this.baseUrl + `transaksiNasabah/bayarTelpon?Nomor%20Rekening=${noRekening}&No%20Telepon=${noTelepon}`,
      {
        responseType: 'json',
      }
    );
  ...
  findBayarTelepon(noRekening: number, noTelepon: number): Observable<any> {
    return this.http.get( this.baseUrl + `transaksiNasabah/findByNoRekAndNoTelp?Nomor%20Rekening=${noRekening}&No%20Telepon=${noTelepon}`,
      {
        responseType: 'json',
      }
    );
  ...
  postBayarteleponPerBulan(noRekening: number, noTelepon:number, bulanKe:number):Observable<any>{
    return this.http.post(this.baseUrl + `transaksiNasabah/bayarTelponPerbulan?Nomor%20Rekening=${noRekening}&No%20Telepon=${noTelepon}&Bulan%20Tagihan=${bulanKe}`,
    {
    responseType: "json",
  });
  }
  ...
  getTotalTagihan(noRekening: number, noTelepon: number): Observable<any> {
    return this.http.get(this.baseUrl + `transaksiNasabah/findTotalTagihan?Nomor%20Rekening=${noRekening}&No%20Telepon=${noTelepon}`, 
    {
      responseType: "json",
