...
export enum IconSubset {
  ...
  cilSpeech = 'cilSpeech',
  cilSpeedometer = 'cil-speedometer',
  ...
  cilHamburgerMenu = 'cil-hamburger-menu',
  cilLockUnlocked = 'cil-lock-unlocked',
  cilSwapHorizontal ='cil-swap-horizontal',
  cilHistory = 'cil-history',
  cilPhone = 'cil-phone',
  cilTransfer = 'cil-transfer',
  cilCash = 'cil-cash',
  cilMoney = 'cil-money',
